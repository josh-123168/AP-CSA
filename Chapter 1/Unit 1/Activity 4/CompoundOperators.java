...
public class CompoundOperators
{
    public static void main(String[] args)
    {
        ...
        System.out.println(
                "I have " + myYears + " years in school and " + (gradYear - myYears) + " years left to gradutate.");
        System.out.println(
                "Bro has " + broYears + " years in school and " + (gradYear - broYears) + " years left to gradutate.");
        System.out.println("Fern has " + fernYears + " years in school and " + (gradYear - fernYears)
                + " years left to gradutate.");
